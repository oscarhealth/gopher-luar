...
func Test_ptr_immutable_edit(t *testing.T) {
	...
	testError(t, L, `_ = str ^ "world"`, "invalid operation for immutable pointer")
}

func Test_ptr_immutable_access(t *testing.T) {
	...
	testReturn(t, L, `return -str`, "hello")
}
